...
class Pakkelabels {
    ...
    public function pickup_requests($params){
        $result = $this->_make_api_call('/pickup_requests', 'GET', $params);
        return $result;
    }
    ...
    public function package_types($params){
        $result = $this->_make_api_call('/package_types', 'GET',$params);
        return $result;
    }
     ...
     * Sales_orders
     */
    public function sales_orders($params){
        $result = $this->_make_api_call('/sales_orders', 'GET',$params);
        return $result;
    }
     ...
     * Sales_orders
     */
    public function sales_orders_post($params){
        $result = $this->_make_api_call('/sales_orders', 'POST',$params);
        return $result;
    }
     ...
     * Sales_orders
     */
    public function shipment_templates($params){
        $result = $this->_make_api_call('/shipment_templates', 'GET',$params);
        return $result;
    }
     ...
     * Proforma invoices
     */
    public function shipment_proforma_invoices($id,$params){
        $result = $this->_make_api_call('/shipments/'. $id .'/proforma_invoices', 'GET', $params);
        return $result;
    }
    ...
    public function shipment($id,$params){
        $result = $this->_make_api_call('/shipments/' . $id,'GET',$params);
        return $result;
    }
