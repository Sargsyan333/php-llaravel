...
export default class ProductSelected extends React.Component {
    state = {
        productCount: 0
    }
    addProduct = (item) => {
    ...
    render() {
        ...
        return (
            <ProductSelectedStyle >
                ...
                <ProductAction showButtons={this.props.productCount > 0 ? true : false}>
                    <div className="product-control">
                        <div className="pieces-text">
                            <div className="amount">{this.props.productCount} kasse</div>
...
const ProductAction = styled.div`
    ...
    .addProduct {
        ...
        transform:${props => props.showButtons === true ? `translateX(-100%)` : `translateX(0%)`};
    }
    .product-control {
        position: absolute;
        left: 0;
...
const ProductSelectedStyle = styled.div`
